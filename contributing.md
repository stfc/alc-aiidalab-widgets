...
This document outlies the best practices for contributing to the alc-aiidalab-widgets project. These must be
...
``` sh
git clone -b issueXYZ --single-branch git@github.com:username/alc-aiidalab-widgets.git 
```
...
$ git clone git@github.com:username/alc-aiidalab-widgets.git 
